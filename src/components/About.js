                    ...
                    <div className="container">
                        <div className="box-shadow-full text-center">
                            <div className="title-box">
                                <h5 className="title-b title-center">
                                    About me
                                </h5>
                            </div>
                            <p className="lead">
                                Software Engineer who is eager to learn and
                                grow, currently residing in Calgary - AB. I have
                                experience using Node.js, CSS, React,
                                TypeScript, C#, .NET, MongoDB, SQL and more...
                            </p>
